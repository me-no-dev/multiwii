...
Numberbox confP_ROLL,confP_PITCH,confP_YAW;
Numberbox confI_ROLL,confI_PITCH,confI_YAW;
...
Slider servoSliderV1,servoSliderV2;
...
Button buttonREAD,buttonWRITE,buttonSTART,buttonSTOP;

Button buttonNunchuk;
Button buttonI2cAcc;
Button buttonI2cBaro;
Button buttonI2cMagneto;
Button buttonLevel;
...
void setup() {
  ...
  buttonSTOP = controlP5.addButton("STOP",1,xGraph+160,yGraph-30,40,19); 
  buttonSTOP.setColorBackground(red_);

  buttonNunchuk = controlP5.addButton("---",1,xButton,yButton,150,15);
  buttonNunchuk.setColorBackground(red_);
  buttonI2cAcc = controlP5.addButton("---",1,xButton,yButton+17,150,15); 
  buttonI2cAcc.setColorBackground(red_);
  buttonI2cBaro = controlP5.addButton("---",1,xButton,yButton+34,150,15); 
  buttonI2cBaro.setColorBackground(red_);
  buttonI2cMagneto = controlP5.addButton("---",1,xButton,yButton+51,150,15); 
  buttonI2cMagneto.setColorBackground(red_);
  buttonLevel = controlP5.addButton("---",1,xButton,yButton+68,150,15); 
  ...
  magSlider  = controlP5.addSlider("7",-200,+200,0,xGraph+60,yGraph+220,50,10);magSlider.setDecimalPrecision(0);
  ...
  servoSliderH1  = controlP5.addSlider("Servo0",1000,2000,1500,xMot,yMot+135,100,10);
  servoSliderH1.setDecimalPrecision(0);
  servoSliderH1.hide();
  servoSliderH2 = controlP5.addSlider("Servo1",1000,2000,1500,xMot,yMot-15,100,10);
  servoSliderH2.setDecimalPrecision(0);
  servoSliderH2.hide();
  servoSliderH3 = controlP5.addSlider("Servo2",1000,2000,1500,xMot,yMot-15,100,10);
  servoSliderH3.setDecimalPrecision(0);
  servoSliderH3.hide();
  servoSliderH4 = controlP5.addSlider("Servo3",1000,2000,1500,xMot,yMot-15,100,10);
  servoSliderH4.setDecimalPrecision(0);
  servoSliderH4.hide();
  servoSliderV1  = controlP5.addSlider("Servov0",1000,2000,1500,xMot,yMot+135,10,100);
  servoSliderV1.setDecimalPrecision(0);
  servoSliderV1.hide();
  servoSliderV2 = controlP5.addSlider("Servov1",1000,2000,1500,xMot,yMot-15,10,100);
  servoSliderV2.setDecimalPrecision(0);
  servoSliderV2.hide();
...
void draw() {
  ...
  servoSliderH1.setValue(servo0);
  servoSliderH2.setValue(servo1);
  servoSliderH3.setValue(servo2);
  servoSliderH4.setValue(servo3);
  servoSliderV1.setValue(servo1);
  servoSliderV2.setValue(servo2);
  ...
  if (multiType == 1) { //TRI
    ...
    textFont(createFont("Arial bold",12), 15);
    text(" TRICOPTER", xCaption,yCaption);
    ...
    servoSliderV1.hide();servoSliderV2.hide();
    ...
    line(xObj,yObj-size*cosb, xObj,yObj);
    textFont(createFont("Arial bold",12), 15);
    text("QUADRICOPTER +", xCaption,yCaption);
    ...
    line(xObj+size*cosa,yObj+size*cosb, xObj,yObj);
    textFont(createFont("Arial bold",12), 15);
    text("QUADRICOPTER X", xCaption,yCaption);
    ...
    line(xObj,yObj-size*cosb, xObj,yObj);
    textFont(createFont("Arial bold",12), 15);
    text("BICOPTER", xCaption,yCaption);
    ...
    motSliderV2.hide();motSliderV3.hide();motSliderV4.hide();motSliderV5.hide();
    servoSliderH3.hide();servoSliderH4.hide();
    servoSliderV1.hide();servoSliderV2.hide();

  } else if (multiType == 5) { //GIMBAL
    textFont(createFont("Arial bold",12), 15);
    text("  GIMBAL", xCaption,yCaption);

    textFont(createFont("Arial bold",12), 15);
    text("GIMBAL", xMot,yMot+25);
 
    servoSliderH3.setPosition(xMot,yMot+75);
    servoSliderH3.setCaptionLabel("ROLL");
    servoSliderH3.show();

    servoSliderH2.setPosition(xMot,yMot+35);
    servoSliderH2.setCaptionLabel("PITCH");
    servoSliderH2.show();
    ...
    line(xObj,yObj+size*cosb, xObj,yObj);
    textFont(createFont("Arial bold",12), 15);
    text("TRICOPTER Y6", xCaption,yCaption);
    ...
    textFont(createFont("Arial bold",12), 15);
    text("HEXACOPTER", xCaption,yCaption);
    ...
    line(xObj,yObj, xObj+2*size*cosa*(1-(cosb-1)/3),yObj+size*cosb);
    line(xObj+2*size*cosa*(1-(cosb-1)/3),yObj+size*cosb,xObj+2*size*cosa,yObj+(size-30*(1-sina/3))*cosb);  
    line(xObj+2*size*cosa,yObj+(size-30*(1-sina/3))*cosb,xObj,yObj-1.5*size*cosb);
    ...
    textFont(createFont("Arial bold",12), 15);
    text("FLYING WING", xCaption,yCaption);

    servoSliderV1.setPosition(xMot+10,yMot+10);
    servoSliderV1.setCaptionLabel("LEFT");
    servoSliderV1.show(); 

    servoSliderV2.setPosition(xMot+90,yMot+10);
    servoSliderV2.setCaptionLabel("RIGHT");
    servoSliderV2.show(); 
...
//  if (nunchukPresent==1) {
    ...
    strokeWeight(1.5);
    fill(0);stroke(0);
    ellipse(xObj-40,  yObj-133,   2*size+7, 2*size+7);
    stroke(255);
    float head= mag*PI/180-PI/2;
    float sinhead = sin(head);
    float coshead = cos(head);
    line(xObj-40+size*coshead,yObj-133+size*sinhead, xObj-40-size*coshead,yObj-133-size*sinhead);   
    line(xObj-40+size*coshead,yObj-133+size*sinhead, xObj-40+10*cos(head+PI/8) ,yObj-133+10*sin(head+PI/8));  
    line(xObj-40+size*coshead,yObj-133+size*sinhead, xObj-40+10*cos(head-PI/8) ,yObj-133+10*sin(head-PI/8));  
...
//  }
  ...
  stroke(225, 225, 125);
  if (magGraph)  g_graph.drawLine(magData, -370, +370);
...
void processSerialData() {
  ...
  if (g_serial.read() == 'A') {
    ...
    if (inBuf[frame_size-1] == 'A') {
      ...
      i2cAccPresent = read8();
      i2cBaroPresent = read8();
      i2cMagnetoPresent = read8();
      levelMode = read8();
      cycleTime = read16();
      angx = read16();
      angy = read16();
    ...
    if (i2cAccPresent>0) {
      buttonI2cAcc.setCaptionLabel("ACC Connected");
      buttonI2cAcc.setColorBackground(green_);
    } else {
      buttonI2cAcc.setCaptionLabel("ACC Absent");
      buttonI2cAcc.setColorBackground(red_);
    }
    if (i2cBaroPresent>0) {
      buttonI2cBaro.setCaptionLabel("BARO Connected");
      buttonI2cBaro.setColorBackground(green_);
    } else {
      buttonI2cBaro.setCaptionLabel("BARO Absent");
      buttonI2cBaro.setColorBackground(red_);
    }
    if (i2cMagnetoPresent>0) {
      buttonI2cMagneto.setCaptionLabel("MAG Connected");
      buttonI2cMagneto.setColorBackground(green_);
    } else {
      buttonI2cMagneto.setCaptionLabel("MAG Absent");
      buttonI2cMagneto.setColorBackground(red_);
    }
