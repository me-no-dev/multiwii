...
Numberbox dynamic_axis_PID1;
Numberbox dynamic_axis_PID2;
Numberbox dynamic_axis_PID3;
...
void setup() {
  ...
  dynamic_axis_PID1 = controlP5.addNumberbox("P1",1,xParam+220,yParam+5,30,14);
  dynamic_axis_PID1.setDecimalPrecision(2);
  dynamic_axis_PID1.setMultiplier(0.01);
  dynamic_axis_PID1.setDirection(Controller.HORIZONTAL);
  dynamic_axis_PID1.setMin(0);
  dynamic_axis_PID1.setMax(1);
  dynamic_axis_PID1.setColorBackground(red_);
  dynamic_axis_PID1.setCaptionLabel("Axis rate PID");

  dynamic_axis_PID2 = controlP5.addNumberbox("P2",1,xParam+260,yParam+5,30,14);
  dynamic_axis_PID2.setDecimalPrecision(2);
  dynamic_axis_PID2.setMultiplier(0.01);
  dynamic_axis_PID2.setDirection(Controller.HORIZONTAL);
  dynamic_axis_PID2.setMin(0);
  dynamic_axis_PID2.setMax(1);
  dynamic_axis_PID2.setColorBackground(red_);
  dynamic_axis_PID2.setCaptionLabel("");

  dynamic_axis_PID3 = controlP5.addNumberbox("P3",1,xParam+300,yParam+5,30,14);
  dynamic_axis_PID3.setDecimalPrecision(2);
  dynamic_axis_PID3.setMultiplier(0.01);
  dynamic_axis_PID3.setDirection(Controller.HORIZONTAL);
  dynamic_axis_PID3.setMin(0);
  dynamic_axis_PID3.setMax(1);
  dynamic_axis_PID3.setColorBackground(red_);
  dynamic_axis_PID3.setCaptionLabel("");
...
int byteP_ROLL,byteI_ROLL,byteD_ROLL,
     ...
     byteDynAxisPID1,byteDynAxisPID2,byteDynAxisPID3,
...
public void READ(int theValue) {
  ...
  dynamic_axis_PID1.setValue(byteDynAxisPID1/100.0);
  dynamic_axis_PID2.setValue(byteDynAxisPID2/100.0);
  dynamic_axis_PID3.setValue(byteDynAxisPID3/100.0);
  ...
  dynamic_axis_PID1.setColorBackground(green_);
  dynamic_axis_PID2.setColorBackground(green_);
  dynamic_axis_PID3.setColorBackground(green_);
...
public void WRITE(int theValue) {
  ...
  byteDynAxisPID1 = (round(dynamic_axis_PID1.value()*100));
  byteDynAxisPID2 = (round(dynamic_axis_PID2.value()*100));
  byteDynAxisPID3 = (round(dynamic_axis_PID3.value()*100));
  ...
  int[] s = new int[32];
   ...
   s[13] = byteDynAxisPID1;
   s[14] = byteDynAxisPID2;
   s[15] = byteDynAxisPID3;
   s[16] = byteDynThrPID1;
   s[17] = byteDynThrPID2;
   s[18] = byteDynThrPID3;
...
void processSerialData() {
  ...
  if (g_serial.read() == 'A') {
    ...
    byteDynAxisPID1 = inBuf[51]&0xff;
    byteDynAxisPID2 = inBuf[52]&0xff;
    byteDynAxisPID3 = inBuf[53]&0xff;
    byteDynThrPID1 = inBuf[54]&0xff;
    byteDynThrPID2 = inBuf[55]&0xff;
    byteDynThrPID3 = inBuf[56]&0xff;
