...
void setup() {
  ...
  confP_ROLL.setMultiplier(0.05);
  confP_ROLL.setDirection(Controller.HORIZONTAL);
  confP_ROLL.setMin(0);
  confP_ROLL.setMax(10);
...
public void READ(int theValue) {
  ...
  float[] datas = new float[11];
  while (g_serial.read() != 'B') {}
  while (myString == null) myString = g_serial.readStringUntil(';');
  datas = float(split(myString, ','));
  confP_ROLL.setValue(datas[0]);
  confI_ROLL.setValue(datas[1]/10.0);
  confD_ROLL.setValue(datas[2]);
  confP_PITCH.setValue(datas[3]);
  confI_PITCH.setValue(datas[4]/10.0);
  confD_PITCH.setValue(datas[5]);
  confP_YAW.setValue(datas[6]);
  confI_YAW.setValue(datas[7]/10.0);
  confD_YAW.setValue(datas[8]);

  confRC_RATE.setValue(datas[9]/10.0);
  confRC_EXPO.setValue(datas[10]/10.0);

  confACC_STRENGTH.setValue(datas[11]);
...
public void WRITE(int theValue) {
  ...
  +round(confP_ROLL.value()*1000)/1000.0+";"
  +round(confI_ROLL.value()*1000)/1000.0+";"
  +round(confD_ROLL.value()*1000)/1000.0+";"
  +round(confP_PITCH.value()*1000)/1000.0+";"
  +round(confI_PITCH.value()*1000)/1000.0+";"
  +round(confD_PITCH.value()*1000)/1000.0+";"
  +round(confP_YAW.value()*1000)/1000.0+";"
  +round(confI_YAW.value()*1000)/1000.0+";"
  +round(confD_YAW.value()*1000)/1000.0+";"
  +round(confRC_RATE.value()*1000)/1000.0+";"
  +round(confRC_EXPO.value()*1000)/1000.0+";"
  +round(confACC_STRENGTH.value()*1000)/1000.0+";");
  g_serial.write(s);
  println(s); 
}
