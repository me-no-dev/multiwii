...
//  #define ITG3200_ADDRESS 0XD0
  ...
  #define DIGITAL_RETRACTS_PINMODE   pinMode(8,OUTPUT); //                              Servo 3 for stretch/slow settings
  #define DIGITAL_RETRACTS_HIGH      PORTB |= 1<<0;
  #define DIGITAL_RETRACTS_LOW       PORTB &= ~(1<<0);
  ...
  #define DIGITAL_TILT_LEFT_PINMODE  pinMode(A2,OUTPUT); //                             Servo 4 for stretch/slow settings
  #define DIGITAL_TILT_LEFT_HIGH     PORTC |= 1<<2;
  #define DIGITAL_TILT_LEFT_LOW      PORTC &= ~(1<<2);
  #define DIGITAL_TILT_RIGHT_PINMODE pinMode(A3, OUTPUT); // also tilt for VTOL_TAIL     Servo 5 for stretch/slow settings
  #define DIGITAL_TILT_RIGHT_HIGH    PORTC |= 1<<3;
  #define DIGITAL_TILT_RIGHT_LOW     PORTC &= ~(1<<3);
  #define DIGITAL_CAM_PINMODE        pinMode(A2,OUTPUT);
  #define DIGITAL_CAM_HIGH           PORTC |= 1<<2;
  #define DIGITAL_CAM_LOW            PORTC &= ~(1<<2);
  #define PPM_PIN_INTERRUPT          attachInterrupt(0, rxInt, CHANGE); //PIN 0          Was 'RISING'
  #define MOTOR_ORDER                9,10,3,11,6,5  //for a quad+: rear,right,left,front Was 9,10,11,3,6,5
...
#if defined(TRI) || defined(VTOL_DUAL) || defined(VTOL_TAIL)
  #define MULTITYPE 1
#elif defined(QUADP)
  #define MULTITYPE 2
#elif defined(QUADX)
