...
/*
	servo[1]  = (axisPID[YAW]*SERVODIR(1,2)) + (axisPID[PITCH]*SERVODIR(1,1));   //   SideServo  5  D12
	servo[2]  = (axisPID[YAW]*SERVODIR(2,2)) + (axisPID[PITCH]*SERVODIR(2,1));   //   SideServo  3  D11
	servo[3]  = (axisPID[YAW]*SERVODIR(3,2)) + (axisPID[ROLL] *SERVODIR(3,1));   //   FrontServo 2  D3
	servo[4]  = (axisPID[YAW]*SERVODIR(4,2)) + (axisPID[ROLL] *SERVODIR(4,1));   //   RearServo  4  D10
*/
