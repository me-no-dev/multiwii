...
//  text("v1.dev", 0, 32);
  ...
  if (multiType == 1) { //TRI
    ...
    servoSliderV[3].setPosition(xMot+5,yMot+10);servoSliderV[3].setCaptionLabel("LEFT");servoSliderV[3].show(); 
    servoSliderV[4].setPosition(xMot+100,yMot+10);servoSliderV[4].setCaptionLabel("RIGHT");servoSliderV[4].show();
    motSlider[0].setPosition(xMot+50,yMot+40);motSlider[0].setHeight(90);motSlider[0].setCaptionLabel("Motor");motSlider[0].show();
