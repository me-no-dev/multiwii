...
if (AccInflightCalibrationArmed && armed == 1 && rcData[THROTTLE] > MINCHECK && !(rcOptions & activate[BOXARM]) ){              // Copter is airborne and you are turning it off via boxarm : start measurement
