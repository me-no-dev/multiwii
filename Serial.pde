...
void serialCom() {
  ...
  if ((!tx_busy) && Serial.available()) {
    ...
    case 'W': //GUI write params to eeprom @ arduino
      ...
      P8[PIDLEVEL] = Serial.read(); 
      I8[PIDLEVEL] = Serial.read(); //17
      P8[PIDMAG] = Serial.read(); //18
      rcRate8 = Serial.read(); 
      rcExpo8 = Serial.read(); //20
      rollPitchRate = Serial.read(); 
      yawRate = Serial.read(); //22
...
// Change philosophy: ALL CHANGES are to #ifdefs. NO CHANGES to actual serial code. Goal is to make integrating Arduino-023+ core lib
aries easier. 
// ************************
