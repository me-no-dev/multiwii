...
static uint8_t modeState = 0;       // VTOL control surface transition direction detection
static uint8_t modeState2 = 0;      // VTOL cycle toggle for slower transition
...
static int16_t lastRcData[8]; // interval [1000;2000]
...
static uint8_t stretch       = STRETCH;
static uint8_t slow          = SLOW;
static uint8_t servoSpeed[6] = SERVO_SPEED;
