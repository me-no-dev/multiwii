...
PinDef PWMPins[MAX_PWM_OUTPUTS] = {
    ...
    { GPIOB, GPIO_Pin_9, GPIO_PinSource9, GPIO_Mode_AF_PP, 0, 0,
        ...
        0, PWM_PERIOD, PWM_MIN, PWM_MAX, PWM_WIDTH, 1 },
    ...
    { GPIOA, GPIO_Pin_11, GPIO_PinSource11, GPIO_Mode_AF_PP, 0, 0,
        ...
        0, PWM_PERIOD_SERVO, PWM_MIN, PWM_MAX, PWM_WIDTH, 1 },
...
PinDef GPIOPins[MAX_GPIO_PINS] = {
    ...
    { GPIOC, GPIO_Pin_14, GPIO_PinSource14, GPIO_Mode_IPU, 0, 0,
        false, { 0, }, 0, }, // Baro MPU6050 Int
    { GPIOC, GPIO_Pin_15, GPIO_PinSource15, GPIO_Mode_IPU, 0, 0,
        false, { 0, }, 0, }, // HMC5883 Ready
    { GPIOC, GPIO_Pin_9, GPIO_PinSource9, GPIO_Mode_IPU, 0, 0,
        false, { 0, }, 0, }, // Landing
//	{ GPIOB, GPIO_Pin_15, GPIO_Mode_Out_PP, 0, 0, false, { 0, }, 0, }, // Probe
...
PinDef SPIIOPins[MAX_SPIIO_PINS] = {
    { GPIOB, GPIO_Pin_12, GPIO_PinSource12, GPIO_Mode_Out_PP, 0, 0,
        false, { 0, }, 0, }, // CS
    { GPIOB, GPIO_Pin_13, GPIO_PinSource13, GPIO_Mode_Out_OD, 0, 0,
        false, { 0, }, 0, }, // SCL
    { GPIOB, GPIO_Pin_14, GPIO_PinSource14, GPIO_Mode_Out_OD, 0, 0,
        false, { 0, }, 0, } // SDA
	};
...
PinDef GPIOPins[MAX_GPIO_PINS] = {
	...
	{ GPIOC, GPIO_Pin_10, GPIO_PinSource10, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // Armed
	{ GPIOC, GPIO_Pin_13, GPIO_PinSource13, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // Baro Enable
	{ GPIOC, GPIO_Pin_14, GPIO_PinSource14, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // Baro MPU6050 Int
	...
	{ GPIOC, GPIO_Pin_9, GPIO_PinSource9,  GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // Landing
	{ GPIOC, GPIO_Pin_6, GPIO_PinSource6, GPIO_Mode_IN, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // Aux1
...
PinDef SPIIOPins[MAX_SPIIO_PINS] = {
	{ GPIOB, GPIO_Pin_12, GPIO_PinSource12, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // CS
	{ GPIOB, GPIO_Pin_13, GPIO_PinSource13, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_UP,
		false, { 0, }, 0, }, // SCL
	{ GPIOB, GPIO_Pin_14, GPIO_PinSource14, GPIO_Mode_OUT, GPIO_OType_OD, GPIO_PuPd_UP,
		false, { 0, }, 0, } // SDA
	};
