...
int byteRC_RATE,byteRC_EXPO, byteRollPitchRate,byteYawRate,
	byteRC_RATEAcro ,byteRC_EXPOAcro, byteRollPitchRateAcro, byteYawRateAcro,
...
Numberbox confRC_RATE, confRC_EXPO, rollPitchRate, yawRate,
		confRC_RATEAcro, confRC_EXPOAcro, rollPitchRateAcro, yawRateAcro,
		dynamic_THR_PID, throttle_EXPO, throttle_MID, 
...
"Select motor(s) and control throttle.").setPosition(xServ-200, yServ+10).moveTo("Motors");
  ...
  rollPitchRateAcro = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("rollPitchRateAcro",0,xParam+160+40,yParam+30,30,14)).setDecimalPrecision(2);
  rollPitchRateAcro.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).setMultiplier(0.01);
  
  yawRateAcro = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("yawRateAcro",0,xParam+160+40,yParam+54,30,14)).setDecimalPrecision(2);
  yawRateAcro.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).setMultiplier(0.01); 
  
  dynamic_THR_PID = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("dynamic_THR_PID",0,xParam+215+30,yParam+22,30,14)).setDecimalPrecision(2);
  ...
  confRC_RATEAcro = controlP5.addNumberbox("RC RATE Acro",1,xParam+40+40+80,yParam+220,30,14).setDecimalPrecision(2).setMultiplier(0.01).setLabel("");
  confRC_RATEAcro.setDirection(Controller.HORIZONTAL).setMin(0).setMax(2.5).setColorBackground(red_);
  confRC_EXPOAcro = controlP5.addNumberbox("RC EXPO Acro",0,xParam+40+40+80,yParam+237,30,14).setDecimalPrecision(2).setMultiplier(0.01).setLabel("");
  confRC_EXPOAcro.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_);
...
public void evaluateCommand(byte cmd, int dataSize) {
  ...
  switch(icmd) {
    ...
    case MSP_RC_TUNING:
        ...
        byteYawRate = read8();
        byteRC_RATEAcro = read8();byteRC_EXPOAcro = read8();byteRollPitchRateAcro = read8();
        byteYawRateAcro = read8();
        byteDynThrPID = read8();
        ...
        confRC_RATEAcro.setValue(byteRC_RATEAcro/100.0);
        confRC_EXPOAcro.setValue(byteRC_EXPOAcro/100.0);
        rollPitchRateAcro.setValue(byteRollPitchRateAcro/100.0);
        yawRateAcro.setValue(byteYawRateAcro/100.0);
        ...
        confRC_RATEAcro.setColorBackground(green_);confRC_EXPOAcro.setColorBackground(green_);rollPitchRateAcro.setColorBackground(green_);
        yawRateAcro.setColorBackground(green_);
 ...
 if(ServosActive){
   ...
   //******************************************************************************************
    ...
    if (toggleWrite) {
      ...
      payload.add(char( round(confRC_RATEAcro.value()*100)) );
      payload.add(char( round(confRC_EXPOAcro.value()*100)) );
      payload.add(char( round(rollPitchRateAcro.value()*100)) );
      payload.add(char( round(yawRateAcro.value()*100)) );
...
//    servoSliderH[3].setPosition(xMot,yMot-5) .setCaptionLabel("N/A").show();
  ...
  fill(255,255,127);
  textFont(font12);
  text((int)angy + "Â°", xLevelObj+38, yLevelObj+78); //pitch
  text((int)angx + "Â°", xLevelObj-62, yLevelObj+78); //roll
  ...
  fill(255,255,127);
  text(head + "Â°",xCompass-11-(head>=10.0 ? (head>=100.0 ? 6 : 3) : 0),yCompass+6);
...
if(!hideDraw){
  ...
  text("T P A",xParam+215+40,yParam+15);
...
public void updateModelMSP_SET_RC_TUNING(){
        ...
        MWI.setProperty("rc.rate.acro",String.valueOf(confRC_RATEAcro.value()));
        MWI.setProperty("rc.expo.acro",String.valueOf(confRC_EXPOAcro.value()));
        MWI.setProperty("rc.rollpitch.rate.acro",String.valueOf(rollPitchRateAcro.value()));
        MWI.setProperty("rc.yaw.rate.acro",String.valueOf(yawRateAcro.value()));
...
public void updateView(){
  ...
  confRC_RATEAcro.setValue(Float.valueOf(MWI.conf.getProperty("rc.rate.acro")));
  confRC_EXPOAcro.setValue(Float.valueOf(MWI.conf.getProperty("rc.expo.acro")));
  rollPitchRateAcro.setValue(Float.valueOf(MWI.conf.getProperty("rc.rollpitch.rate.acro")));
  yawRateAcro.setValue(Float.valueOf(MWI.conf.getProperty("rc.yaw.rate.acro")));
