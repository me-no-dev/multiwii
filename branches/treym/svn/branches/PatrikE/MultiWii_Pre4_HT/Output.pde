...
//============================================================================================================== 
  #ifdef HEADTRACKER    
   // Data for PPM Injection
    HT_Roll  = constrain(TILT_ROLL_MIDDLE  -(accSmooth[0]*AXP[0]) , TILT_ROLL_MIN, TILT_ROLL_MAX);   //Pan |   the direction of the 2 servo can be changed here: 
    HT_Tilt  = constrain(TILT_PITCH_MIDDLE -(accSmooth[1]*AXP[1]) , TILT_PITCH_MIN, TILT_PITCH_MAX); //Nick|   invert the sign before axisPID
 
   // Data to GUI and servos on A0,A1.
    servo[0]   =constrain(TILT_ROLL_MIDDLE +(accSmooth[0]*AXP[0]) , TILT_ROLL_MIN, TILT_ROLL_MAX); 
    servo[1]  = constrain(TILT_PITCH_MIDDLE +(accSmooth[1]*AXP[1]) , TILT_PITCH_MIN, TILT_PITCH_MAX);
    
   // Data for CompassArrow in GUI
    heading = map(servo[0], 1020, 1980, -90, 90);
   #endif
  //============================================================================================================== 
