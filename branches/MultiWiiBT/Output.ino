...
*/
    ...
    bi_travel = 500 * MAX_BI_SERVO / 100;
    servo[4]  = constrain(1500 + (YAW_DIRECTION * axisPID[YAW]) + axisPID[PITCH], 1020 + bi_travel, 2000 - bi_travel); //LEFT
    servo[5]  = constrain(1500 + (YAW_DIRECTION * axisPID[YAW]) - axisPID[PITCH], 1020 + bi_travel, 2000 - bi_travel); //RIGHT
