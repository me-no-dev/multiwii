  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
     ...
     //#define FREEIMUv043     // same as FREEIMUv04 with final MPU6050 (with the right ACC scale)
		#define UAVXARM32F4		// UAVX Arm Board
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
     ...
     #ifdef USE_SERIAL_PPM_JR // set by Makefile
		#define SERIAL_SUM_PPM         PITCH,YAW,THROTTLE,ROLL,AUX1,AUX2,AUX3,AUX4 //For Graupner/Spektrum
     #elif USE_SERIAL_PPM_FUT // set by Makefile
...
/*************************************************************************************************/
  ...
  /******                Serial com speed    *********************************/
    /* This is the baud rate of the serial interface */
    #define SERIAL_COM_BAUD 115200
...
/*************************************************************************************************/
  ...
  /* Pseudo-derivative controller for level mode (experimental)
  ...
  /********************************************************************/
    ...
    #define VBATSCALE     0.0445f // change this value if readed Battery voltage is different than real voltage
