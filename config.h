...
#define BI
  ...
  /****************************    Motor minthrottle    *******************************/
    ...
    //#define MINTHROTTLE 1150 // for Super Simple ESCs 10A
    //#define MINTHROTTLE 1064 // special ESC (simonk)
    #define MINTHROTTLE 1200 // special ESC (simonk)
...
//    #define CONTROLL_RANGE   { 100, 100 }      //  { ROLL,PITCH }
    #define CONTROLL_RANGE   { 10, 10 }      //  { ROLL,PITCH }
  ...
  /***********************      biCopter Settings     ***********************/
    /* Maximum Servo travel (percentage) */
   #define MAX_BI_SERVO 50
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      ...
      //#define SERIAL_SUM_PPM         THROTTLE,ROLL,PITCH,YAW,AUX1,AUX2,AUX3,AUX4 //For Graupner/Spektrum
