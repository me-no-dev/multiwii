...
#ifdef DAEDALUSFC
#define ACCEL_ENABLED   ( 1 << 0 )
#define BARO_ENABLED    ( 1 << 1 )
#define MAG_ENABLED     ( 1 << 2 )
uint8_t g_swState = 0x00;
#endif DEADLUSFC
...
void setup() {
  ...
  ////
  // A3 as MSB and A0 as LSB to match
  // switch print-out
  // A3 = 1, ..., A0 = 4
  g_swState = digitalRead(A3);
  g_swState |= digitalRead(A2) << 1;
  g_swState |= digitalRead(A1) << 2;
  g_swState |= digitalRead(A0) << 3;
