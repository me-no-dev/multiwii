...
void readEEPROM() {
  ...
  activateCamStab8 = EEPROM.read(p++);activateCamTrig8 = EEPROM.read(p++);activateArm8 = EEPROM.read(p++); // 22
...
void writeParams() {
  ...
  EEPROM.write(p++,activateCamStab8);EEPROM.write(p++,activateCamTrig8);EEPROM.write(p++,activateArm8); // 22
