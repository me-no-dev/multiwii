...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    #define MAG_DECLINIATION  1.88f                //For Kiel, Germany
    //#define MAG_DECLINIATION  1.00f                //For Emden, Germany
  ...
  /********************************************************************/
    ...
    #define VBATSCALE     120.5 // change this value if readed Battery voltage is different than real voltage
  ...
  /********************************************************************/
    ...
    #define PLEVELDIV 1500 // to convert the sum into mAh divide by this value
    ...
    #define PSENSORNULL 126 // for I=0A my sensor gives 1/2 Vss; that is approx 2.49Volt
    #define PINT2mA 12 // for telemtry display: one integer step on arduino analog translates to mA (example 4.9 / 37 * 100)
